pub use crate::triangulation::halfedge_triangulation::HalfedgeTriangulation;

use crate::triangulation::ear_clip::triangulate_ear_clip;
use nalgebra::{Point2, Vector3};

#[cfg(feature = "test_thoroughly")]
use crate::util::math::ccw;

mod ear_clip;
mod halfedge_triangulation;
...
pub fn triangulate_idx_halfedges(
	...
	if allow_convex && is_convex(polys, epsilon) {
		...
		result = triangulate_ear_clip(polys, epsilon);
	};
